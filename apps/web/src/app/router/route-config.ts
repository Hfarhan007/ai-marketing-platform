...
export const workspaceRoutes = [
  ...
  workspace('metaAds', 'meta-ads/:section?', 'Meta Ads', { permission: 'campaigns:read' }),
  ...
  workspace('leadSourceReport', 'analytics/lead-sources', 'Lead Source Reporting', { permission: 'leads:read' }),
