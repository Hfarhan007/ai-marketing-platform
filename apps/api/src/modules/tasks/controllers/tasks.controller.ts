...
import { CrmListQueryDto, VersionDto } from '../../crm/crm.dto.js';
...
export class TasksController {
  ...
  @Delete(':id') @RequirePermissions('tasks.manage') remove(
    @WorkspaceContext() c: WorkspaceRequestContext,
    @Param('id', ParseMongoIdPipe) id: string,
    @Query() d: VersionDto,
  ) {
