...
@Module({
  ...
  providers: [AiMemoryRepository, AiMemoryService, MemoryExtractionPolicy, AgentRunsRepository, AgentMemoryRepository, AgentMemoryPolicyService, AgentMemoryService, AgentExecutionPolicy, AgentToolRegistry, AgentToolExecutor, StarterToolProvider, StarterToolRegistrar, AgentRunnerService, MongooseRuntimeStore, AgentRuntimeEventsService, AgentRuntimeRecordsService, { provide: AGENT_RUNTIME_STORE, useExisting: MongooseRuntimeStore }, { provide: AGENT_RUNTIME_EVENTS, useExisting: AgentRuntimeEventsService }, AgentRuntimeService, AgentRunQueueService, AgentRunWorker],
  exports: [AiMemoryService, AgentMemoryService, AgentToolExecutor, AgentRunnerService, AgentRuntimeService, AgentRunQueueService, AgentRuntimeEventsService, AgentRuntimeRecordsService],
})
